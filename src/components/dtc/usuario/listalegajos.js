...
{/* <Ver 
        ...
        const handleDownload = async (dataIndex) => {
          ...
          setCargando(true)
       await fetch('https://backpipo.ciudaddecorrientes.gov.ar/dtc/descargar/'+ chicos[dataIndex]['id'])
      //   await fetch('http://localhost:4000/dtc/descargar/'+ chicos[dataIndex]['id'])
        ...
        const handleDownloadd = async (dataIndex) => {
            // Lógica para descargar el archivo
            setCargando(true)
         await fetch('https://backpipo.ciudaddecorrientes.gov.ar/dtc/descargar/'+ dataIndex)
