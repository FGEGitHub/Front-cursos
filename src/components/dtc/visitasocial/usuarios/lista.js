    ...
    function CutomButtonsRenderer(dataIndex, rowIndex, data, onClick) {
        return (
            <>
                ...
                <div onClick={() => navigate('/dtc/visitasocial/usuario/' + chicos[dataIndex]['id'])} >

                    < Tooltip title="Ver">
                        <Button  onClick={() => navigate('/dtc/visitasocial/usuario/' + chicos[dataIndex]['id'])} variant="contained">
Ver                        </Button>
                    </Tooltip>
