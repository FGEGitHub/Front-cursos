...
export default function Clasenueva(props) {
    ...
    const traer = async () => {
        ...
        const turnos = await servicioCarnaval.traerinscripcionesenc(props.id)
        setEscuelas(turnos)
    ...
    const handleDeterminar = async (event) => {
        ...
        const respuesta = await servicioCarnaval.asignarinscripciones({id:props.id, inscrip:selectedOptions})
        alert(respuesta)
