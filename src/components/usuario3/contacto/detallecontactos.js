...
import servicioAdmin from '../../../services/coordinadores'
  ...
  const getClients = async () => {
      ...
      if (loggedUserJSON) {
        ...
        console.log(usuario)
          ...
          const clients = await servicioAdmin.contactos(usuario.id)
          ...
          <div>
            ...
            {vista ? <>
              <MUIDataTable
                ...
                title={"Distribucion de llamados"}
                data={clients}
                columns={columns}
                actions={[
                  {
      ...
      <Table sx={{ minWidth: "20%",maxWidth: "1000%"}} aria-label="customized table">
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell >CONFIRMADOS</StyledTableCell>
            <StyledTableCell  >RECHAZADOS</StyledTableCell>
            
            <StyledTableCell align="left">SIN RESPONDER</StyledTableCell>
        ...
        <TableBody>
          {clients.map((row) => (
            <StyledTableRow  key={row.id}>       
              ...
              <StyledTableCell >{row.confirmados}</StyledTableCell>
              <StyledTableCell >{row.rechazados}</StyledTableCell>
              <StyledTableCell  >{row.asignados}</StyledTableCell>
