import servicioEncaegados from '../../../services/encargados'
...
const TablaNotificaciones = (props) => {
    ...
    const traer = async () => {
        try {
            ...
            if (loggedUserJSON) {
                ...
                const novedades_aux = await servicioEncaegados.listadeausentes(usuario.id)
 ...
 Para justificar la alumna tiene que tener ausente  <strong   onClick={() => navigate('/')}> click para Ir a clases</strong>
</Alert>
