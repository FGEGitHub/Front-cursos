...
return data
  ...
  const crearpuntos = async (puntos) => {
  
    // const data = await axios.post('http://localhost:4000/signupp', datos)
      const {data} = await axios.post(baseUrl+'crearpuntos/', puntos, config)
return data
  ...
  const puntos = async () => {
    ...
    // const data = await axios.post('http://localhost:4000/signupp', datos)
      const {data} = await axios.get(baseUrl+'puntos/', config)
return data
...
return data
  ...
  const eliminarhorario = async (id) => {
    ...
    // const data = await axios.post('http://localhost:4000/signupp', datos)
      const {data} = await axios.post(baseUrl+'eliminarhorariocursado/',id, config)
return data
...
const borrarpunto = async (id) => {
  const response = await axios.delete(`${baseUrl}/borrarpunto/${id}`);
  return response.data;
};
...
const agregarHorario = async (data) => {
  try {
    ...
    const response = await axios.post(`${baseUrl}horarios`, {
      id_tallerista: data.id_tallerista,
      dia: data.dia,
...
const eliminarHorarioo = async (id) => {
  try {
    console.log(id)
    const response = await axios.delete(`${baseUrl}eliminarHorarioo/${id}`);
    return response.data;
  } catch (error) {
...
const modificarHorario = async (data) => {
  console.log(data)
  const res = await axios.post(`${baseUrl}ponerhorarios/${data.id}`, data);
  return res.data;
};


const traerhorariosusuario = async (datas) => {
  console.log(datas)
  const res = await axios.post(`${baseUrl}traerhorariosusuario/`, datas);
  return res.data;
};
...
const traerhorairoastalleres = async (id) => {
  const {data} = await axios.get(`${baseUrl}traerhorairoastalleres/`+id);
